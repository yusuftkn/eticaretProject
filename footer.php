			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone"><?php echo $ayarcek['ayar_tel']; ?> <br> +387 123 456</li>
						<li class="fmobile"><?php echo $ayarcek['ayar_faks'];  ?><br>+387-123-456-2</li>
						<li class="fmail lastone"><?php echo $ayarcek['ayar_mail'];  ?><br>customer.care@mail.com</li>
					</ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author']; ?> <a href="htpp://222.joyakademi.com">www.joyakademi.com </a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="htpp://<?php echo $ayarcek['ayar_google']; ?>" class="ffeed">google</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
