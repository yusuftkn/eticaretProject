							...
							<div class="regwrap">
								<div class="row">
									<div class="col-md-6 regform">
										...
										<form action="nedmin/netting/islem.php" method="POST" role="form">
											<div class="form-group">
												<input type="text" class="form-control" name="kullanici_mail" id="username" placeholder="Kullanıcı Adınız(mail">
											</div>
											<div class="form-group">
												<input type="password" class="form-control" name="kullanici_pasword" id="password" placeholder="Şifreniz">
											</div>
									...
									<div class="col-md-6">
										...
										<p>
											Alışverişe başlamanız için lütfen kayıt olunuz.
										</p>
