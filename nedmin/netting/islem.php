...
if (isset($_POST['sliderkaydet'])) {
	...
	$benzersizad= uniqid();
	$refimgyol="dimg/slider/".$benzersizad.'_'.$name;
	$file_name= $benzersizad.'_'.$name;
...
if (isset($_POST['kullanicigiris'])) {
	...
	$kullanicisor->fetch(PDO::FETCH_ASSOC);
	$say=$kullanicisor->rowCount();
	if ($say==1) {
...
if (isset($_POST['kullanicibilgiguncelle'])){
	...
	$ayarkaydet=$db->prepare("UPDATE FROM kullanici SET
		kullanici_adsoyad=:kullanici_adsoyad,
