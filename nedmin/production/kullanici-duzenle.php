                  ...
                  <div class="x_content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="first-name" name="kullanici_zaman" value="<?php echo $zaman[0]; ?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      ...
                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Kullanici Durum<span class="required">*</span>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <!-- kısa if Kullanımı -->
                          <option value="0"<?php echo $kullanicicek['kullanici_durum']=='1'?'selected=""': ''; ?>>Aktif</option>
